  ...
  const dailyItinerary = [
    {
      day: 1,
      title: '西宁 - 青海湖 - 德令哈',
      morning: '前往青海湖断崖，路途可观赏大片油菜花，景区有壮观的湟鱼洄游和海鸟飞翔（6 - 8月最佳）。',
    ...
    {
      day: 3,
      title: '格尔木 - 水上雅丹 - 翡翠湖 - 大柴旦',
      morning: '沿着U型公路前往水上雅丹，沿途可以在安全区域拍摄公路大片，抵达景区参观水上雅丹特殊地貌。',
      afternoon: '途经南八仙魔鬼城，观赏荒漠雅丹；日落时分欣赏大自然的色彩美学盐湖-翡翠湖。',
      evening: '晚上入住大柴旦镇区民宿，品尝当地美食。',
      image: 'https://youjb.com/images/2025/06/26/PixPin_2025-06-26_15-44-499a0ff97a9cc2bcc4.png'
    },
    {
      day: 4,
      title: '大柴旦 - 如意湖 - 黑独山 - 敦煌',
      morning: '前往如意湖，这里是新开发的景区，面积最大的盐湖景区。',
    ...
    {
      day: 5,
      title: '敦煌 - 敦煌博物馆 - 鸣沙山月牙泉',
      morning: '前往免费的敦煌博物馆了解敦煌的历史。',
      afternoon: '前往鸣沙山月牙泉，体验骑骆驼，欣赏沙漠日落，体验万人大合唱。',
      evening: '入住敦煌市区民宿，逛敦煌夜市，品尝驴肉黄面、杏皮水等特色。',
    ...
    },
    {
      day: 7,
      title: '嘉峪关 - 七彩丹霞 - 祁连',
      morning: '前往张掖丹霞国家地质公园，参观游览。这里是中国最美的丹霞地貌之一。',
    ...
    {
      day: 8,
      title: '祁连 - 卓尔山后山 - 岗什卡雪峰 - 门源花海 - 西宁',
      morning: '前往卓尔山后山，观赏雪山与草原。',
      afternoon: '打卡此程最高海拔景点，近距离目睹雪山，返程途中前往门源观察大片油菜花。',
      evening: '入住西宁市区民宿，品尝当地美食。',
        ...
        <section id="overview" className="mb-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-8">
              本次青甘大环线顺时针自驾游从西宁出发，途经德令哈、格尔木、大柴旦、敦煌、嘉峪关、张掖、祁连等地，最后返回西宁。全程约3500公里，涵盖了高原湖泊、草原、雪山、戈壁、沙漠、雅丹、丹霞地貌等多种自然景观，以及莫高窟等人文历史遗迹。
            </p>
